...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_blogpost', 'post_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['blog.Post'], unique=True, primary_key=True), keep_default=False)
