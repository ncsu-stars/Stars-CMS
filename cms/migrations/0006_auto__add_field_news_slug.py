...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_news', 'slug', self.gf('django.db.models.fields.SlugField')(default=1, max_length=100, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'News.slug'
        db.delete_column('cms_news', 'slug')
