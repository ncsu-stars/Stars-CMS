...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_project', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Project'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.parent'
        db.delete_column('cms_project', 'parent_id')
    ...
    models = {
        ...
        'cms.member': {
            'Meta': {'ordering': "['user__first_name']", 'object_name': 'Member'},
        ...
        'cms.project': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Project']", 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'year': ('django.db.models.fields.IntegerField', [], {})
        },
        'cms.projectmember': {
            'Meta': {'ordering': "['-is_coordinator', 'member__user__first_name', 'volunteer_name']", 'object_name': 'ProjectMember'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
