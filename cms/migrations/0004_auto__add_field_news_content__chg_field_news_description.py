...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_news', 'content', self.gf('django.db.models.fields.TextField')(default=1), keep_default=False)

        # Changing field 'News.description'
        db.alter_column('cms_news', 'description', self.gf('django.db.models.fields.TextField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting field 'News.content'
        db.delete_column('cms_news', 'content')

        # Changing field 'News.description'
        db.alter_column('cms_news', 'description', self.gf('django.db.models.fields.TextField')())
