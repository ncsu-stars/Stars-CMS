...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_project', 'coordinator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='coordinator', to=orm['cms.Member']), keep_default=False)
    ...
    models = {
        ...
        'cms.project': {
            ...
            'coordinator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'coordinator'", 'to': "orm['cms.Member']"}),
