...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectMember.volunteer_name'
        db.add_column('cms_projectmember', 'volunteer_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Member.status'
        db.add_column('cms_member', 'status', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectMember.volunteer_name'
        db.delete_column('cms_projectmember', 'volunteer_name')

        # Deleting field 'Member.status'
        db.delete_column('cms_member', 'status')
