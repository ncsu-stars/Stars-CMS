...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_project', 'year', self.gf('django.db.models.fields.IntegerField')(default=1234), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.year'
        db.delete_column('cms_project', 'year')
    ...
    models = {
        ...
        'cms.blogpost': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'tags'", 'blank': 'True', 'to': "orm['cms.Tag']"}),
