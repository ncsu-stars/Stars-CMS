...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cms_project', 'coordinator_id')

        # Deleting field 'Project.active'
        db.delete_column('cms_project', 'active')

        # Adding field 'Project.status'
        db.add_column('cms_project', 'status', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)

        # Adding field 'ProjectMember.role'
        db.add_column('cms_projectmember', 'role', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'ProjectMember.is_coordinator'
        db.add_column('cms_projectmember', 'is_coordinator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Member.city'
        db.delete_column('cms_member', 'city')

        # Deleting field 'Member.state'
        db.delete_column('cms_member', 'state')

        # Adding field 'Member.hometown'
        db.add_column('cms_member', 'hometown', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('cms_project', 'coordinator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cms.Member']), keep_default=False)
        ...
        db.delete_column('cms_project', 'status')

        # Deleting field 'ProjectMember.role'
        db.delete_column('cms_projectmember', 'role')

        # Deleting field 'ProjectMember.is_coordinator'
        db.delete_column('cms_projectmember', 'is_coordinator')

        # Adding field 'Member.city'
        db.add_column('cms_member', 'city', self.gf('django.db.models.fields.CharField')(default='Raleigh', max_length=255), keep_default=False)

        # Adding field 'Member.state'
        db.add_column('cms_member', 'state', self.gf('django.db.models.fields.CharField')(default='NC', max_length=2), keep_default=False)

        # Deleting field 'Member.hometown'
        db.delete_column('cms_member', 'hometown')
    ...
    models = {
        ...
        'cms.projectmember': {
            ...
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Member']", 'blank': 'True'}),
