...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_blogpost', 'id', self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True), keep_default=False)

        # Adding field 'BlogPost.title'
        db.add_column('website_blogpost', 'title', self.gf('django.db.models.fields.CharField')(default=1, max_length=255), keep_default=False)

        # Adding field 'BlogPost.date'
        db.add_column('website_blogpost', 'date', self.gf('django.db.models.fields.DateTimeField')(default=1), keep_default=False)

        # Adding field 'BlogPost.post'
        db.add_column('website_blogpost', 'post', self.gf('django.db.models.fields.TextField')(default=1), keep_default=False)
