...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('website_member', ['user_id'])

        # Adding M2M table for field tags on 'BlogPost'
        db.create_table('website_blogpost_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blogpost', models.ForeignKey(orm['website.blogpost'], null=False)),
            ('tag', models.ForeignKey(orm['website.tag'], null=False))
        ))
        db.create_unique('website_blogpost_tags', ['blogpost_id', 'tag_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Member', fields ['user']
        db.delete_unique('website_member', ['user_id'])

        # Deleting model 'Tag'
        db.delete_table('website_tag')

        # Removing M2M table for field tags on 'BlogPost'
        db.delete_table('website_blogpost_tags')
