...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_project', 'coordinator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='coordinator', to=orm['website.Member']), keep_default=False)
    ...
    models = {
        ...
        'website.project': {
            ...
            'coordinator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'coordinator'", 'to': "orm['website.Member']"}),
